...
#### Scenario: LLM enabled via the plan
...
#### Scenario: LLM returns null, remainder takes over
...
#### Scenario: LLM absent, zero overhead
...
#### Scenario: LLM breaks stagnation (single-shot at or past midpoint)
