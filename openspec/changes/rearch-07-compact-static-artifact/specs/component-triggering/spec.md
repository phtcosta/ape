...
- **THEN** the injected intent SHALL be `ACTION_VIEW` with `Uri.parse("myapp://detail/x")`, targeted at `ComponentName("com.x", "com.x.DetailActivity")`
